...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $validationErrors = array(); //creation d'un tableau pour inser les erreurs 
    ...
    <div class="container user-page">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <div class="input-container">
                <input pattern=".{4,}" title="Le login doit contenir au moins 4 caractères" class="form-control" type="text" name="login" autocomplete="off" placeholder="Taper votre Login" required="required">
            </div>
            <div class="input-container">
                <input minlength=4 class="form-control" type="password" name="pwd1" autocomplete="new-password" placeholder="Taper votre mot de passe" required>
            </div>
            <div class="input-container">
                <input minlength=4 class="form-control" type="password" name="pwd2" autocomplete="new-password" placeholder="Retaper votre mot de passe pour le confirmer" required>
            </div>
            <div class="input-container">
